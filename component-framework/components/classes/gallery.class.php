...
class Oxygen_VSB_Gallery extends CT_Component {
    ...
    function generate_css($selector) {
        ...
        if (isset($this->param_array['hide_captions_below']) && $this->param_array['hide_captions_below'] != 'never') { ?>
    ...
    function shortcode($atts) {
        ...
        if ($this->js_added == false && $this->param_array['lightbox'] == 'yes' && $this->param_array['link'] == 'yes') { 
            $photoswipecode .= '
                    ...
                    <?php echo "<".$linktag.$href; ?> class='oxy-gallery-item'>
                        <div class='oxy-gallery-item-sizer'>
                            ...
                            <figure class='oxy-gallery-item-contents' style='background-image: url(<?php echo $gallery_image["thumb_url"]; ?>);'>
                                ...
                                <img src="<?php echo $gallery_image["thumb_url"]; ?>" data-original-src="<?php echo $gallery_image["url"]; ?>" data-original-src-width="<?php echo $gallery_image["width"]; ?>" data-original-src-height="<?php echo $gallery_image["height"]; ?>" alt="<?php echo $gallery_image["alt"]; ?>">
                ...
                <?php foreach ($gallery_images as $gallery_image) {
                    ...
                    <?php echo "<".$linktag.$href; ?> class='oxy-gallery-item'>
                        ...
                        <figure class='oxy-gallery-item-contents'>
                            ...
                            <img src="<?php echo $gallery_image["url"]; ?>" data-original-src="<?php echo $gallery_image["url"]; ?>" data-original-src-width="<?php echo $gallery_image["width"]; ?>" data-original-src-height="<?php echo $gallery_image["height"]; ?>" alt="<?php echo $gallery_image["alt"]; ?>">
                            <figcaption><?php echo $gallery_image["caption"]; ?></figcaption>
        ...
        if ($this->param_array['lightbox'] == 'yes' && $this->param_array['link'] == 'yes' && isset($atts['preview']) && $atts['preview'] == 'true') { ?>
            <script type="text/javascript">
                setTimeout(function() {
                    if (jQuery('.oxy-gallery-item-contents').length) {
                        jQuery('.oxy-gallery').photoSwipe('.oxy-gallery-item-contents');
                    }
                }, 100);
            </script>
        <?php } 
        ...
        // frontend 
        if ($this->param_array['link'] == 'yes' && $this->param_array['lightbox'] == 'yes' && (!isset($atts['preview']) || $atts['preview'] != 'true')) { ?>
            <script type="text/javascript">
                jQuery('.oxy-gallery').photoSwipe('.oxy-gallery-item-contents');
            </script>
        <?php } 
        ...
        return $photoswipecode.$defaultcss.$optioncss.$html;
    }
...
global $OXY_Gallery;
$OXY_Gallery = new Oxygen_VSB_Gallery(
        array(
