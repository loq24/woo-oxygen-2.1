...
class Oxygen_VSB_Icon_Box extends CT_Component{
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        ?> 
            ...
            <?php echo $params["selector"]; ?> .oxy-icon-box-heading {
                <?php echo $this->typography_to_css($params, 'icon_box_heading_typography', $defaults); ?>
                <?php if(isset($params['icon_box_heading_space_above'])) $this->output_single_css_property("margin-top",
                    $params['icon_box_heading_space_above'], $this->get_css_unit('icon_box_heading_space_above', $params, $defaults)); ?>
                <?php if(isset($params['icon_box_heading_space_below'])) $this->output_single_css_property("margin-bottom",
                    $params['icon_box_heading_space_below'], $this->get_css_unit('icon_box_heading_space_below', $params, $defaults)); ?>
            }

            <?php echo $params["selector"]; ?> .oxy-icon-box-text {
                <?php echo $this->typography_to_css($params, 'icon_box_text_typography', $defaults); ?>
                <?php if(isset($params['icon_box_heading_space_above'])) $this->output_single_css_property("margin-top",
                    $params['icon_box_heading_space_above'], $this->get_css_unit('icon_box_text_space_above', $params, $defaults)); ?>
                <?php if(isset($params['icon_box_heading_space_below'])) $this->output_single_css_property("margin-bottom",
                    $params['icon_box_heading_space_below'], $this->get_css_unit('icon_box_text_space_below', $params, $defaults)); ?>
                <?php if(isset($icon_vertical_alignment_align_self)) $this->output_single_css_property("align-self", $icon_vertical_alignment_align_self); ?>
            }
    ...
    function css_output() {
        ...
        $defaultcss = file_get_contents(plugin_dir_path(__FILE__)."icon-box/icon-box.css");
    ...
    function shortcode($atts, $content) {
        ...
        <div id='<?php echo esc_attr($options['selector']); ?>' class='<?php echo esc_attr($options['classes']); ?>'>
          ...
          <div class='oxy-icon-box-content'>
            <h2 class='oxy-icon-box-heading'>
              <?php echo base64_decode($this->param_array[$options['id']]['icon_box_heading']); ?>
            </h2>
            <p class='oxy-icon-box-text'>
              <?php echo base64_decode($this->param_array[$options['id']]['icon_box_text']); ?>
            </p>
...
$Icon_Box = new Oxygen_VSB_Icon_Box( array(
