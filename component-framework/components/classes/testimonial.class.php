...
class Oxygen_VSB_Testimonial extends CT_Component {
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        ob_start();
            ...
            <?php echo $params["selector"]; ?> .oxy-testimonial-photo {
                <?php if(isset($params['testimonial_image_size'])) $this->output_single_css_property("width",
                    $params['testimonial_image_size'], $this->get_css_unit('testimonial_image_size', $params, $defaults)); ?>
                <?php if(isset($params['testimonial_image_size'])) $this->output_single_css_property("height",
                    $params['testimonial_image_size'],$this->get_css_unit('testimonial_image_size', $params, $defaults)); ?>
                <?php echo $margincss; ?>;
            }
            ...
            <?php echo $params["selector"]; ?> .oxy-testimonial-content-wrap {
                ...
                <?php if(isset($flexalign)) $this->output_single_css_property("text-align", $textalign); ?>
            }

            <?php echo $params["selector"]; ?> .oxy-testimonial-text {
                <?php if (isset($params['testimonial_text_space_below'])) echo "margin-bottom:" . $params['testimonial_text_space_below'] . $this->get_css_unit('testimonial_text_space_below', $params, $defaults) . ";"; ?>
                <?php echo $this->typography_to_css($params, 'testimonial_text_typography', $defaults); ?>
            }

            <?php echo $params["selector"]; ?> .oxy-testimonial-author {
                <?php if (isset($params['testimonial_author_space_below'])) echo "margin-bottom:" . $params['testimonial_author_space_below'] . $this->get_css_unit('testimonial_author_space_below', $params, $defaults) . ";"; ?>
                <?php echo $this->typography_to_css($params, 'testimonial_author_typography', $defaults); ?>
            }

            <?php echo $params["selector"]; ?> .oxy-testimonial-author-info {
                <?php if (isset($params['testimonial_author_info_space_below'])) echo "margin-bottom:" . $params['testimonial_author_info_space_below'] . $this->get_css_unit('testimonial_author_info_space_below', $params, $defaults) . ";"; ?>
                <?php echo $this->typography_to_css($params, 'testimonial_author_info_typography', $defaults); ?>
            }
    ...
    function css_output() {
        ...
        $defaultcss = file_get_contents(plugin_dir_path(__FILE__)."testimonial/testimonial.css");
    ...
    function shortcode($atts) {
        ...
        if ($this->param_array[$options['id']]['testimonial_photo']) { ?>
            ...
            <div class='oxy-testimonial-photo-wrap'>
                <img src='<?php echo $this->param_array[$options['id']]['testimonial_photo']; ?>' class='oxy-testimonial-photo' />
            </div>
        ...
        <div id="<?php echo esc_attr($options['selector']); ?>" class='<?php echo esc_attr($options['classes']); ?> <?php echo "oxy-testimonial-".$this->param_array[$options['id']]['testimonial_layout']; ?>'>

            <?php echo $photo_html; ?>

            <div class='oxy-testimonial-content-wrap'>
                <div class='oxy-testimonial-text'>
                    <?php echo base64_decode($this->param_array[$options['id']]['testimonial_text']); ?>
                </div>
                <div class='oxy-testimonial-author-wrap'>
                    <div class='oxy-testimonial-author'>
                        <?php echo base64_decode($this->param_array[$options['id']]['testimonial_author']); ?>
                    </div>
                    <?php if ($this->param_array[$options['id']]['testimonial_author_info']) { ?>
                        <div class='oxy-testimonial-author-info'>
                            <?php echo base64_decode($this->param_array[$options['id']]['testimonial_author_info']); ?>
                        </div>
                    <?php } ?>
                </div>
            </div>
...
$Testimonial = new Oxygen_VSB_Testimonial( array(
