...
Class Oxy_Nav_Menu extends CT_Component {
	...
	function add_shortcode( $atts, $content ) {
		...
		?><nav id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>"><div class='oxy-menu-toggle'><div class='oxy-nav-menu-hamburger-wrap'><div class='oxy-nav-menu-hamburger'><div class='oxy-nav-menu-hamburger-line'></div><div class='oxy-nav-menu-hamburger-line'></div><div class='oxy-nav-menu-hamburger-line'></div></div></div></div><?php 
				...
				<div class="oxygen-control-row">
					<div class='oxygen-control-wrapper' id='oxygen-typography-font-family'>
						...
						<div class='oxygen-control'>
							...
							<div class="oxygen-select oxygen-select-box-wrapper">
								<div class="oxygen-select-box">
									<div class="oxygen-select-box-current">{{iframeScope.getOption('menu_font-weight')}}</div>
									<div class="oxygen-select-box-dropdown"></div>
								</div>
								<div class="oxygen-select-box-options">
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','')">&nbsp;</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','100')">100</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','200')">200</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','300')">300</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','400')">400</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','500')">500</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','600')">600</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','700')">700</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','800')">800</div>
									<div class="oxygen-select-box-option" 
										ng-click="iframeScope.setOptionModel('menu_font-weight','900')">900</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class='oxygen-control-wrapper'>
						...
						<div class='oxygen-control'>
							<div class='oxygen-icon-button-list'>
								<?php $oxygen_toolbar->icon_button_list_button('menu_justify-content','flex-start','text-align/left.svg','text-align/left--active.svg'); ?>
								<?php $oxygen_toolbar->icon_button_list_button('menu_justify-content','center','text-align/center.svg','text-align/center--active.svg'); ?>
								<?php $oxygen_toolbar->icon_button_list_button('menu_justify-content','flex-end','text-align/right.svg','text-align/right--active.svg'); ?>
								<?php $oxygen_toolbar->icon_button_list_button('menu_justify-content','stretch','text-align/justify.svg','text-align/justify--active.svg'); ?>
							</div>
						</div>
					</div>
				</div>
...
// Create inctance
$nav_menu = new Oxy_Nav_Menu( array( 
			'name' 		=> __('Menu','oxygen'),
			'tag' 		=> 'oxy_nav_menu',
			'params' 	=> array(
					array(
