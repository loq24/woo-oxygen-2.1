...
Class CT_Slide extends CT_Component {
	...
	function add_shortcode( $atts, $content ) {
		...
		?><li><div id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>"><?php echo do_shortcode( $content ); ?></div></li><?php
...
$oxygen_slide = new CT_Slide( array( 
