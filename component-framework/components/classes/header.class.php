...
Class Oxy_Header_Builder extends CT_Component {
	...
	function add_shortcode( $atts, $content ) {
		...
		?><header id="<?php echo esc_attr($options['selector']); ?>" class="oxy-header-wrapper <?php echo ($options["sticky_header"]=="yes") ? "oxy-sticky-header " : ""; echo $overlay_class; ?> <?php echo esc_attr($options['classes']); ?>"><?php echo do_shortcode( $content ); ?></header>
