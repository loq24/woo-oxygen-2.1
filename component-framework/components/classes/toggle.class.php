...
Class Oxy_Toggle extends CT_Component {
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        <?php echo $params["selector"]; ?> .oxy-expand-collapse-icon {
            <?php if(isset($params['toggle_icon_size'])) $this->output_single_css_property("font-size", $params['toggle_icon_size'], $this->get_css_unit('toggle_icon_size', $params, $defaults)); ?>
        }

        <?php echo $params["selector"]; ?> .oxy-expand-collapse-icon::before,
        <?php echo $params["selector"]; ?> .oxy-expand-collapse-icon::after {
            <?php if(isset($params['toggle_icon_color'])) $this->output_single_css_property("background-color", $params['toggle_icon_color']); ?>
        }
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		?><div id="<?php echo esc_attr($options['selector']); ?>" class="<?php if(isset($options['classes'])) echo esc_attr($options['classes']); ?>" data-oxy-toggle-target="<?php echo esc_attr($options['toggle_target']); ?>" data-oxy-toggle-initial-state="<?php echo esc_attr($options['toggle_init_state']); ?>" data-oxy-toggle-active-class="<?php echo esc_attr($options['toggle_active_class']); ?>">
    ...
    function css_output() {
        ...
        $defaultcss = file_get_contents(plugin_dir_path(__FILE__)."toggle/toggle.css");
	...
	function output_js() { ?>
		...
		<script type="text/javascript">
			...
			oxygenVSBInitToggleClick = function() {
