...
Class CT_Fancy_Icon extends CT_Component {
	...
	function add_shortcode( $atts, $content ) {
		...
		?><div id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>"><svg id="svg-<?php echo esc_attr($options['selector']); ?>"><use xlink:href="#<?php echo esc_attr($options['icon_id']); ?>"></use></svg></div><?php
