...
Class Oxy_Tabs extends CT_Component {
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		?><div id="<?php echo esc_attr($options['selector']); ?>" class="oxy-tabs-wrapper <?php if(isset($options['classes'])) echo esc_attr($options['classes']); ?>" data-oxy-tabs-active-tab-class='<?php echo esc_attr($options['active_tab_class']); ?>' data-oxy-tabs-contents-wrapper='<?php echo esc_attr($options['tabs_contents_wrapper']); ?>'><?php echo do_shortcode( $content ); ?></div><?php
    ...
    function css_output() {
        ...
        $defaultcss = file_get_contents(plugin_dir_path(__FILE__)."tabs/tabs.css");
