...
Class Oxy_Tabs_Content extends CT_Component {
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		?><div id="<?php echo esc_attr($options['selector']); ?>" class="oxy-tabs-contents-wrapper <?php if(isset($options['classes'])) echo esc_attr($options['classes']); ?>"><?php echo do_shortcode( $content ); ?></div><?php
