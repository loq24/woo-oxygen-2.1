    ...
    return {
        ...
        link: function(scope, element) {
            ...
            scope.addComponent = function(componentName, type, notActivate) {
                ...
                if (scope.log) {
                    console.log("addComponent()", componentName, type, notActivate);
                }
                ...
                // set template for Easy Posts
                if ( componentName == "oxy_posts_grid" ) {
                    scope.setEasyPostsTemplate(scope.easyPostsDefaultTemplates['grid-image-standard'], false);
                }

                // set template for Easy Posts
                if ( componentName == "oxy_comments" ) {
                    scope.setCommentsListTemplate(scope.commentsListDefaultTemplates['default']);
                }
