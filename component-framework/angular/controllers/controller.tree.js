...
CTFrontendBuilder.controller("ComponentsTree", function($scope, $parentScope, $timeout) {
    ...
    $scope.pasteComponentToTree = function(key, parent, id) {
        ...
        if (componentElement && componentElement.hasClass('oxy-tabs-contents')) {
    ...
    $scope.componentsReorder = function(item, index, startParentId, endParentId, startParent, endParent) {
        ...
        if (endParent.hasClass("ct-slider")) {
            $scope.rebuildDOM(endParentId);
        }
        if (!$scope.reorderSameParent&&startParent.hasClass("ct-slider")) {
        ...
        if (endParent.hasClass("ct-new-columns")&&startParentId==endParentId) {
            $scope.rebuildDOM(endParentId);
        }
        else if (endParent.hasClass("ct-new-columns")) {
            $scope.rebuildDOM(startParentId);
    ...
    $scope.builderInit = function(tree) {
        ...
        $parentScope.showLoadingOverlay("builderInit()");
        ...
        $parentScope.hideLoadingOverlay("builderInit()");
        ...
        var timeout = $timeout(function() {
            ...
            if (oxygenVSBInitToggleState!==undefined&&oxygenVSBInitToggleClick!==undefined) {
