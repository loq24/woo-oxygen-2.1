...
<div class='oxygen-control-row'>
	...
	<?php $this->colorpicker_with_wrapper("border-all-color",__("Color","oxygen"),"oxygen-typography-font-color", "ng-show=\"currentBorder=='all'\""); ?>
	<?php $this->colorpicker_with_wrapper("border-top-color",__("Color","oxygen"),"oxygen-typography-font-color", "ng-show=\"currentBorder=='top'\""); ?>
	<?php $this->colorpicker_with_wrapper("border-left-color",__("Color","oxygen"),"oxygen-typography-font-color", "ng-show=\"currentBorder=='left'\""); ?>
	<?php $this->colorpicker_with_wrapper("border-bottom-color",__("Color","oxygen"),"oxygen-typography-font-color", "ng-show=\"currentBorder=='bottom'\""); ?>
	<?php $this->colorpicker_with_wrapper("border-right-color",__("Color","oxygen"),"oxygen-typography-font-color", "ng-show=\"currentBorder=='right'\""); ?>
