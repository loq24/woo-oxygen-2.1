<div class='wrap oxygen-admin-screen-home'>
		...
		<div class='oxygen-admin-screen-home-left'>
			...
			<div class='oxygen-admin-screen-home-section'>
				...
				<ul>
					...
					<li>
						<a href='https://oxygenbuilder.com/forums'>Visit the Oxygen Forums</a>
					</li>
					<li>
						<a href='https://oxygenbuilder.com/learn'>Tutorials &amp; Documentation</a>
					</li>
				</ul>
	...
	?>
		<div class='oxygen-admin-screen-home-section-design-set-chooser'>
			...
			<?php if($site) { ?>
			<div class='oxygen-admin-screen-home-section-design-set-chooser-text'>The <?php echo $site?> pre-built website has been installed from the Oxygen Design Library.</div>
			<?php } ?>
