<div class="ct-template-anchors">
	...
	<label>
		<input class="ct-template-anchor" type="radio" name="ct_template_type" value="header_footer" <?php checked( $template_type, "header_footer"); ?>>
		<?php _e("Header/Footer", "component-theme"); ?>
	</label>
...
<div id="ct_header_footer" class="ct-template-section">
	<?php _e("Name","component-theme"); ?>
	<input type="text" name="ct_template_header_footer_name" value="<?php echo esc_attr( $template_header_footer_name ); ?>">
	<span class="description"><?php _e("used in get_header()/get_footer(), i.e <b>\"shop\"</b> for WooCommerce <b>get_header('shop')</b>","component-theme"); ?></span>
</div><!-- #ct_header_footer -->